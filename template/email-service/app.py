...
def send_simple_message(to, subject, body):
    return requests.post(
        "https://api.mailgun.net/v3/sandboxe0d1d707afc0472a889de8dd6f05bdaa.mailgun.org/messages",
        auth=("api", "8a329858f088f2c31b2d5679d631bca6-9c988ee3-ff32412e"),
        data={"from": "Mailgun Sandbox <postmaster@sandboxe0d1d707afc0472a889de8dd6f05bdaa.mailgun.org>",
              "to": to,
              "subject": subject,
              "html": body})
